    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-semibold font-inter text-gray-900 text-start ">Sign In</h1>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onBlur={handleBlur}
                  value={values.email}
                  className={`w-full px-4 py-3 border rounded-md text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 ${
